...
func TestChainSpecJSONReproducability(t *testing.T) {
	...
	ioutil.WriteFile(filepath.Join(outTestChainsJSONDir, "README.md"), []byte(`
...
// func TestConstantinopleTestParse(t *testing.T) {
// 	by, err := ioutil.ReadFile(filepath.Join(testChainsJSONDir, "constantinople_test.json"))
// 	if err != nil {
// 		t.Fatal(err)
// 	}
//
...
// 		t.Fatal(err)
// 	}
// 	g := p.ToMultiGethGenesis()
// 	if g.Config.EthashBlockReward(big.NewInt(0)).Cmp(big.NewInt(2000000000000000000)) != 0 {
// 		t.Fatal("mismatch")
// 	}
// }
